...
export var product = {
  prodimg: '/lap.jpg',
  prodname: 'Xiaomi Mi Notebook Ultra',
  prodcolor: 'Red',
  prodquan: 1,
  cart: false,
  price: 63999
...
export default function Home() {
  ...
  const togglecart = () => {
    ...
    if (carter) {
      ...
      tarprodarr.items.push(targetprod)
      console.log(tarprodarr) */
      //const returnedobj = Object.assign(tarprodarr,tarprodcopy);

    }

    else {
      remit(); setstatus('Add to cart');
      ...
      /* tarprodarr.items = tarprodarr.items.filter(item => item["description"] !== product.prodname);
      console.log(tarprodarr) */
    }
...
return (
  <div class="dark:bg-gray-800 text-gray-900 dark:text-white">
    ...
    <div >
      ...
      <h1 class="p-5 mb-4 text-3xl font-extrabold text-gray-900 dark:text-white md:text-5xl lg:text-6xl"><span class="text-transparent bg-clip-text bg-gradient-to-r to-emerald-600 from-sky-400">Laptops</span></h1>
